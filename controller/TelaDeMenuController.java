...
public class TelaDeMenuController extends TelaDeMenuView {
    public static void abrirTelaDeCadastroView() {
        ...
        TelaDeCadastroView.appTelaDeCadastroView.setDefaultCloseOperation
        (DISPOSE_ON_CLOSE);
    ...
    public static void abrirTelaDePesquisaView() {
        ...
        TelaDePesquisaView.appTelaDePesquisaView.setDefaultCloseOperation
        (DISPOSE_ON_CLOSE);
        appTelaDeMenuView.setVisible(false);
    ...
    public static void abrirTelaDeAtualizacaoView() {
        ...
        TelaDeAtualizacaoView.appTelaDeAtualizacaoView.setDefaultCloseOperation
        (DISPOSE_ON_CLOSE);
        appTelaDeMenuView.setVisible(false);
    ...
    public static void abrirTelaDeRemoverView() {
        ...
        TelaDeRemoverView.appTelaDeRemoverView.setDefaultCloseOperation
        (DISPOSE_ON_CLOSE);
        appTelaDeMenuView.setVisible(false);
    ...
    public static void abrirTelaDeLoginView() {
        TelaDeLoginView.appTelaDeLoginView = new TelaDeLoginView();
        TelaDeLoginView.appTelaDeLoginView.setDefaultCloseOperation
        (DISPOSE_ON_CLOSE);
        appTelaDeMenuView.setVisible(false);

        TelaDeLoginView.appTelaDeLoginView.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent e){
                appTelaDeMenuView.setVisible(true);
            }
